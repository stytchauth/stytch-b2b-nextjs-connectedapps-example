  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>Both roles are fulfilled by the same demo, so we'll try to be clear on which role is occurring at each step.</p>
        ...
        <p>The flow this app will take advantage of is the Authorization Code Flow with PKCE. When configuring this app as a client app in Stytch, please select "Third Party Public" as the Client type.</p>
        <br />
       </div>
      <br />
    </div>
